...
test.describe('Head tag area', () => {
    test("Contains the head tag and it's contents", async ({ page }) => {
        await page.goto(homePage); //always at the begining
        await expect(page).toHaveTitle('Example #1'); //it will expect the following on that page
...
test.describe('Main content tests', () => {
    ...
    test('Should containt list to describe CRUD', async ({page}) => {
        await page.goto(homePage);
...
test.describe('Linking to another page', () => {
    ...
    test('Should containt a link to grades page', async ({ page }) => {
        await page.goto(homePage);
...
test.describe('Footer tests', () => {
    test('Check about page navigates to home page ', async ({ page }) => {
    await page.goto(homePage);
    await expect(page.locator('footer')).toContainText('This is an in class example #1');
    })
})

test.describe('Check about page navigates to home page ', () => {
    test('Should navigate to the home page from about page', async ({ page }) => {
